 ...
 * @s2: The secondstringto be compared.
 *
...
/**
 * get_value - Get the numericalvalue of a card.
 * @card: A pointerto a deck_node_tcard.
...
/**
 * sort_deck - Sort a deck of cards from aceto kingand
 *            from spades to diamonds.
 * @deck: A pointerto thehead ofa deck_node_tdoubly-linked list.
 */
void sort_deck(deck_node_t **deck)
{
